...
# model settings
model = dict(
    backbone=dict(drop_path_rate=0.2, adapter_scale=0.5, num_frames=16),
    cls_head=dict(num_classes=8),
    test_cfg=dict(max_testing_views=4)
    )

# dataset settings
dataset_type = 'VideoDataset'
data_root = 'data/to/dataset'
data_root_val = 'data/to/dataset'
ann_file_train = 'data/to/path'
ann_file_val = 'data/to/path'
ann_file_test = 'data/to/path'
img_norm_cfg = dict(
...
work_dir = './work_dirs/ve8_swin_base_patch244_window1677.py'
