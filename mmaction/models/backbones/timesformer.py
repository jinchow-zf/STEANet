...
class TimeSformer(nn.Module):
    ...
    def __init__(self, input_resolution: int, num_frames: int, patch_size: int, width: int, layers: int, heads: int, drop_path_rate, adapter_scale=0.5, attn_type=None, pretrained=None):
        super().__init__()
